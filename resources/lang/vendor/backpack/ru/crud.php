...
return [
    ...
    */
    ...
    'details_row_loading_error' => 'There was an error loading the details. Please retry.',
        ...
        'delete_confirmation_message'                 => 'Элемент был удален успешно',
        'delete_confirmation_not_title'               => 'Элемент не удален',
        'delete_confirmation_not_message'             => "Произошла ошибка. Элемент не был удален",
        'delete_confirmation_not_deleted_title'       => 'Элемент не удален',
        'delete_confirmation_not_deleted_message'     => 'Ничего не произошло. Элемент не был удален',
    ...
    'update_success' => 'Элемент успешно отредактирован',
